/*
  Иконки — инлайновый SVG, без внешних файлов и шрифтов: приложение работает
  офлайн. Цвет наследуется от текста (stroke="currentColor").
*/
...
/** Стук — костяшки по двери: рука у дверного полотна. */
export const knock = svg(
  '<path d="M4 3h9v18H4z"/><path d="M10 12h.01"/><path d="M17 8.5l2.5 2.5-2.5 2.5"/><path d="M19.5 11H15"/>'
);
